    ...
    <#list comments as comment>
        ...
        <article class="comment">
                <section style="text-align:left">
                 <#assign i=i+1> ${i}楼&nbsp;&nbsp;${comment.name}&nbsp;&nbsp;${comment.date}<br/><br/>
                <p>${comment.content}</p><br/>
                </section>
            </article>
    </#list>>
    		<div class="form-horizontal" role="form" style="margin:100px">
     ...
     <br/>
        ...
        <br/>
        <div align="left" style="position:relative;left:13%">
                        ...
                        $("#commentButton").click(function () {
                            if($("#content").val()==''&&$("#name").val()==''&&$("#email").val()==''){
                             ...
                             $("#info").text("");
                                $.ajax({
                                    type: "POST",
                                    //相对路径不加"/",前缀是detial.jsp的前缀，就是Blog-System/
                                    url: "addComment",
                                    data: {
                                        content: $("#content").val(),
                                        name: $("#name").val(),
