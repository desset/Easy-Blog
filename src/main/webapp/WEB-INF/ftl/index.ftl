...
<body background="static/images/bg1.png" >
    ...
    <header id="header">
        <nav>
            <ul>
                <li>
                    <a href="">首页</a>
                    <!-- admin前面不要加"\"，否则会将admin解析成为项目名 -->
                    <a href="main">管理员</a>
                </li>
            </ul>
            <div class="my-info" onmouseover="hiddeewm()" onmouseout="hiddeewm()">
                <figure></figure>
                <a href="https://github.com/desset/Easy-Blog" style="color:white">大漠落日</a>
            </div>
        </nav>
    </header>
    <div id="bg" >
...
<#list articles as article>
 <article class="article">
    ...
    <!-- <h3>--------------------------${pageInfo.pageNum}</h3> -->

</#list> 
        <div style="text-align: center">
        	
              <ul class="pagination" >
                <li <#if pageInfo.pageNum==1> class="disabled" </#if>> <a href="?page=1">&laquo;</a></li>
                <#list 1..pageInfo.pages as t>
                    <li <#if pageInfo.pageNum==t>class="active" </#if>><a href="?page=${t}">${t}</a></li>
                </#list>
                <li <#if pageInfo.pageNum==pageInfo.pages>class="disabled"</#if>><a href="?page=${pageInfo.pages}">&raquo;</a></li>
            </ul>  
        </div>
</div>
    <footer id="footer">
