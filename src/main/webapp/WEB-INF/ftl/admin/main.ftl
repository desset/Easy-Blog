...
<nav class="navbar navbar-expand-lg navbar-light bg-light" >
    ...
    <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
        <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
            ...
            <!-- "<%=request.getContextPath() %>/index"相当于根目录下的requestmapping("index") 
            	而只写"index"表示相对目录下的requestmapping("admin/index")
            -->
                <a class="nav-link" href="index">主页 </a>
            </li>
            <li class="nav-item">
                <!--<a class="nav-link" href="article/list">文章管理</a>-->
                <a class="nav-link" href="article_list">文章管理</a>

            </li>

        </ul>
        <!-- get方式提交的参数编码，只支持iso8859-1编码。因此，如果里面有中文。在后台(article/search)就需要转换编码，如下 
		String bname = request.getParameter("bname"); 
		bname = new String(bname .getBytes("iso8859-1"),"utf-8");  -->
        <!-- post可以转码，提交表单时用post方法 -->
...
<div class="card mb-3">
    <div style="height: 180px;overflow: hidden">
        <img class="card-img-top" src="static/images/long.png" alt="Card image cap" style="height: 100%;width:100%;">
    </div>
